...
def main():
    ...
    try:
        # Use a config file from the same directory as the script if not provided
        config_file = args.config or os.path.join(PROJECT_ROOT, 'config.json')
        monitor = ChatMonitor(config_file)
