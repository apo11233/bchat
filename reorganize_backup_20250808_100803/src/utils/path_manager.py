...
class PathManager:
    ...
    def _find_project_root(self) -> str:
        ...
        current = Path(__file__).parent.parent.parent.absolute()  # Go up to bchat root from src/utils/
        
        # Look for indicators of project root
        indicators = ['config.json', '.git', 'package.json', 'chat_monitor.py']
        ...
        # Fallback to bchat project root (parent of src directory)
